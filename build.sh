...
docker run --platform linux/amd64 zaidulinkirill96/ffmpeg-test:6.6 -re -i https://stream.revma.ihrhls.com/zc185/hls.m3u8 -f segment -segment_time 5 -loglevel fatal chunk-%d.mp3
